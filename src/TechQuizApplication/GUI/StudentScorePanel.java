...
public StudentScorePanel() {
   ...
   public StudentScorePanel(ArrayList<String> examId){
       this();
       this.examId=examId;
       loadUI();
   }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("STUDENT's SCORE DETAILS");

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(204, 204, 0));
        jLabel11.setText("Select Exam ID");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("C:\\Users\\ANURAG GUPTA\\Desktop\\project\\questionpaper4.jpg")); // NOI18N
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addComponent(txtPer, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addComponent(txtLang)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(jcExamId, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(0, 0, Short.MAX_VALUE))
...
this.dispose();
    ...
    private void jcExamIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcExamIdActionPerformed
        ...
        if(examId.equals("ExamId")){
            JOptionPane.showMessageDialog(null,"Please select an ExamId","No selection",JOptionPane.INFORMATION_MESSAGE);
        }
        try{
            ...
            txtPer.setText(String.valueOf(scoreObj.getPer()));
               ...
               JOptionPane.showMessageDialog(null,"Error in connection","No selection",JOptionPane.INFORMATION_MESSAGE);
               ex.printStackTrace();
           }
